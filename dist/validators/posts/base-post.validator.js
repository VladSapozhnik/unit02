...
exports.basePostValidator = [
    (0, express_validator_1.body)('title').isString().withMessage('Title must be a string').trim().isLength({ min: 2, max: 30 }).withMessage('Title length must be between 2 and 30'),
